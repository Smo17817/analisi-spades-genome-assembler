...
# Output
my_output <- paste("/home/simonedassisi/Desktop/BUSCO_output/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('BUSCO_output.bacteria_odb12', 'BUSCO_output.bacteria_odb12', 'BUSCO_output.bacteria_odb12', 'BUSCO_output.bacteria_odb12', 'BUSCO_output.enterobacteriaceae_odb12', 'BUSCO_output.enterobacteriaceae_odb12', 'BUSCO_output.enterobacteriaceae_odb12', 'BUSCO_output.enterobacteriaceae_odb12')
...
my_percentage <- c(99.1, 0.0, 0.0, 0.9, 99.5, 0.1, 0.1, 0.3)
my_values <- c(115, 0, 0, 1, 870, 1, 1, 2)
